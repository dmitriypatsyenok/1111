...
export const BirthdaysView: React.FC<BirthdaysViewProps> = ({ birthdays, lang }) => {
  ...
  return (
    <div className="space-y-3.5 animate-fade-in">
      {/* Today Banner */}
      {todayBdays.length > 0 && (
        <div className="bg-indigo-600/15 border border-indigo-500/30 rounded-3xl p-4 flex items-center gap-3.5 shadow-sm">
            ...
            <div key={monthIdx} className="space-y-2">
              ...
              <div className="space-y-2">
                {list.map((item, idx) => (
                  ...
                  >
                    <div className="w-9 h-9 rounded-xl bg-indigo-600/15 border border-indigo-500/20 text-indigo-400 flex items-center justify-center shrink-0 text-sm">
                      🎂
                    </div>
                    <div className="flex-1 min-w-0">
