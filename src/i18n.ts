...
export const I18N = {
  ...
  be: {
    ...
    confirm_clear_all_data: "Вы ўпэўнены, што хочаце СМІНУЦЬ УСЕ даныя праграмы (расклад, ДЗ, дзяжурства, падзеі, апытанні)? Гэта дзеянне нельга адмяніць!",
    ...
    tg_webhook_success: "✓ Webhook паспяхова падлучаны! Бот будзе адказваць на /app і выдаляць паведамленні.",
    ...
    zone_name_placeholder: "Назва зоны (напр. '1 повер')",
