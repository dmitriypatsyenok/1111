...
export const I18N = {
  ...
  be: {
    ...
    clear_all_data_d: "Поўны скід: расклад, дамашнія заданні, дзяжурствы, падзеі і апытанні",
    confirm_clear_all_data: "Вы ўпэўненыя, што хочаце СКІНУЦЬ УСЕ даныя праграмы (расклад, дамашнія заданні, дзяжурствы, падзеі, апытанні)? Гэтае дзеянне нельга скасаваць!",
