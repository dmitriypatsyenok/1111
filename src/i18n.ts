...
export const I18N = {
  ...
  be: {
    ...
    clear_all_data: "🔥 Скінуць УСЕ дадзеныя прыкладання",
    clear_all_data_d: "Поўны скід: ДЗ, чаргоўства, мерапрыемствы і апытанні",
    confirm_clear_all_data: "Вы ўпэўнены, што хочаце СКТНУЦЬ УСЕ дадзеныя прыкладання (ДЗ, чаргоўства, мерапрыемствы, апытанні)? Гэта дзеянне нельга адмяніць!",
    tg_bot_title: "🤖 Налада Telegram Паведамленняў",
