...
export const I18N = {
  ru: {
    ...
    clear_all_data_d: "Полный сброс: ДЗ, дежурства, мероприятия и опросы",
    confirm_clear_all_data: "Вы уверены, что хотите ОБНУЛИТЬ ВСЕ данные приложения (ДЗ, дежурства, мероприятия, опросы)? Это действие нельзя отменить!",
  ...
  be: {
    ...
    clear_all_data_d: "Поўны скід: ДЗ, дзяжурства, падзеі і апытанні",
    confirm_clear_all_data: "Вы ўпэўнены, што хочаце СМІНУЦЬ УСЕ даныя праграмы (ДЗ, дзяжурства, падзеі, апытанні)? Гэта дзеянне нельга адмяніць!",
