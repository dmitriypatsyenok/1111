...
import { BirthdayItem, DutiesStore, HomeworkStore, Language, PollData, ScheduleProfiles } from './types';
...
interface SettingsViewProps {
  ...
  tgConfig?: { token: string; chatId: string };
  ...
  onClearAllData: () => void;
  onSaveTgConfig?: (token: string, chatId: string) => void;
}
